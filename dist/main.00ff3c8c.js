...
})({"fF58y":[function(require,module,exports) {
...
var _mainTitle = require("/src/js/components/mainTitle/mainTitle");
var _productCard = require("/src/js/components/productCard/productCard");
function getMainPage() {
    const page = document.createElement("div");
    page.classList.add("page", "main-page");
    const mainTitle = (0, _mainTitle.getMainTitle)("Главная страница");
    const list = document.createElement("ul");
    list.classList.add("product-list", "list-reset");
    list.append((0, _productCard.getProductCard)("Товар_1", 400), (0, _productCard.getProductCard)("Товар_2", 300), (0, _productCard.getProductCard)("Товар_3", 700));
    page.append(mainTitle, list);
    return page;
}

},{"/src/js/components/mainTitle/mainTitle":"ki5if","/src/js/components/productCard/productCard":"9WzTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ki5if":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"/src/js/main":"1SICI","./productCard.css":"8FtH3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8FtH3":[function() {},{}]},["fF58y"], null, "parcelRequire08cb")
